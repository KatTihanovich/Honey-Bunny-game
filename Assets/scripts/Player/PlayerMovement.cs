...
public class PlayerMovement : MonoBehaviour
{
    ...
    [SerializeField] private float moveSpeed = 12f; // Movement speed
    [SerializeField] private float jumpHeight = 17f;
    [SerializeField] private float gravity = 33f;

    private bool isFacingRight = true; // For sprite flipping
    private Vector2 moveVelocity; // Smoothed movement velocity
    private bool isGrounded; // Check if player is grounded
    private float verticalVelocity; // For jump and fall mechanics
   ...
   private void HandleFingerMove(Finger movedFinger)
{
    ...
    private void IsGrounded()
    {
        ...
        isGrounded = Physics2D.BoxCast(boxCastOrigin, boxCastSize, 0f, Vector2.down, 0.1f, groundLayer);
    ...
    private void HandleJump()
{
    ...
    private void SetCharacterState(string state)
    {
        ...
        {
            SetAnimation(falling, true, 0.5f);
        }
